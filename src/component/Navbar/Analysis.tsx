        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <StatCard title="Total Transactions" value="278" icon={Activity} color={{bg: "bg-green-100", text: "text-green-600"}}/>
              <StatCard title="Active Farmers" value="35" icon={Users} color={{bg: "bg-blue-100", text: "text-blue-600"}}/>
              <StatCard title="Distributors" value="18" icon={Truck} color={{bg: "bg-yellow-100", text: "text-yellow-600"}}/>
              <StatCard title="Retailers" value="22" icon={Store} color={{bg: "bg-purple-100", text: "text-purple-600"}}/>
            </div>

            {/* --- Transaction Trend Chart --- */}
            <ChartCard title="Transactions Over Time">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={transactionTrend} margin={{ top: 5, right: 20, left: -10, bottom: 5 }}>
                  <defs>
                  ...
                  <Area type="monotone" dataKey="transactions" stroke="#22c55e" strokeWidth={3} fillOpacity={1} fill="url(#colorTransactions)" />
                </AreaChart>
              </ResponsiveContainer>
            </ChartCard>
          ...
          <div className="bg-white shadow-sm rounded-xl border border-slate-200 p-6 flex flex-col justify-center text-center space-y-4 lg:sticky lg:top-8 h-fit">
              ...
              <h3 className="text-lg font-semibold text-gray-800">Live Supply Chain Map</h3>
              <p className="text-sm text-slate-500">
                Visualize the journey of products from farms to retailers in real-time.
              </p>
              <div className="w-full h-80 bg-slate-100 rounded-lg flex items-center justify-center border-2 border-dashed border-slate-300">
                <span className="text-slate-400 font-medium">Map Integration Placeholder</span>
              </div>
          </div>
